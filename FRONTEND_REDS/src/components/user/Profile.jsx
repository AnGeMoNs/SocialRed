      ...
      <header className="aside__profile-info">
        ...
        <div className="profile-info__general-info">
          ...
          <div className="general-info__container-names">
            <h1 className="content__title">{user.name} {user.surname}</h1>
            {user._id != auth._id &&
              (iFollow ?
                <button onClick={() => unfollow(user._id)} className="content__button content__button--right">Unfollowing</button>
                :
